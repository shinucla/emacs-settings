...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'kooten
   '(default ((t (:family "Consolas" :foundry "nil" :width normal :height 180 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "white" :background "black" :stipple nil :inherit nil))))
